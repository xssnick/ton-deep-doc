...
* params:bytes = Наш метод не принимает входных параметров, значит нам нужно передать ему пустой стек (`000000`, 3 байта - стек 0 глубины) сериализованый в BoC -> `b5ee9c72410101010005000006000000d0095f45` -> сериализуем в bytes и получаем `14b5ee9c72410101010005000006000000d0095f45000000` 0x14 - размер, 3 байта в конце - падинг
...
```
1[8_]      -> C0     -> 0b10000000->0b1**1**000000
7[FE]      -> FF     -> 0b11111110->0b1111111**1**

...
Для установки соединения нам нужно знать ip и порт сервера, публичный ключ сервера (можно получить из конфига), и сгенерировать свой приватный и публичный ключ ed25519.
...
* [32 байта] **Свой публичный ключ ed25519** [[?]](## "Можно генерировать новую пару на каждое соединение")
